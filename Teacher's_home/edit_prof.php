...
$sql = "SELECT id,name,Email, Phone_no, Address, Zip FROM teacher WHERE name='{$_SESSION['name']}'";
$result = $db->query($sql);
  ...
  while($row = $result->fetch_assoc()) {?>
                  ...
                  <form action="edit_prof_proc.php" method="POST">
                    ...
                    <div class="mb-3 row">
                      ...
                      <input type="text" class="form-control col-8" id="userid" aria-describedby="" value="Teacher"  disabled>
